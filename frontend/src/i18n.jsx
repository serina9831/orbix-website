  ...
  al: {
    ...
    nav: {
      links: [
        ...
        { label: 'Paketat', hash: '#paketat', testid: 'nav-link-pricing' },
    ...
    pricing: {
      ...
      accent: 'Paketën',
      post: ' e Duhur',
      intro: 'Dy paketa të qarta — çmimi final personalizohet sipas nevojave të biznesit tënd gjatë konsultës falas.',
      oneTime: '/njëherë',
      monthlyLabel: '+',
      recommended: 'Rekomanduar',
      waGreeting: 'Përshëndetje ORBIX! Jam i interesuar për paketën',
      plans: [
        {
          eyebrow: 'Core',
          name: 'Core Agent',
          ...
          featured: false,
          features: [
            'Agent AI 100% personalizuar për biznesin tënd',
            'Përgjigje automatike 24/7, brenda sekondash',
            'Mbledhje & kualifikim automatik i lead-eve',
            'Caktim automatik takimesh, sinkronizuar me kalendar',
            'Konfirmime & rikujtesa automatike',
            'Kalim tek njeriu kur nevojitet',
            'Bazë njohurish e integruar (shërbime, çmime, orare)',
            'Raporte mujore mbi performancën + suport email',
          ],
          addon: '+200€ — s\'ke ende website? Ta ndërtojmë: modern, responsive, deri 7 faqe.',
          cta: 'Fillo tani',
        },
        {
          eyebrow: 'Omni',
          name: 'Omni Agent',
          channels: 'Web + WhatsApp + Instagram + Facebook',
          setup: '500€',
          monthly: '179€/muaj',
          featured: true,
          features: [
            'Gjithçka nga Core Agent',
            'Kanale shtesë: Instagram (DM+komente) & Facebook Messenger',
            'Histori e unifikuar mes të gjitha kanaleve',
            'Dashboard privat, live, në kohë reale',
            'Eksport automatik i lead-eve (gati për CRM/Sheets)',
            'Analitikë e avancuar mbi performancën',
            'Lexim & analizë e dokumenteve komplekse',
            'Mbështetje prioritare 24/7',
          ],
          addon: '+300€ — website premium deri 12 faqe, SSL + hosting/domain 1 vit falas.',
          cta: 'Merr Omni',
        },
      ],
    },
    ...
    faq: {
      ...
      post: '',
      items: [
        { q: 'Sa kushton një agjent AI për biznesin tim?', a: 'Paketat tona nisin nga 300€ + 99€/muaj për Core Agent, deri në 500€ + 179€/muaj për Omni Agent — varet nga kanalet dhe funksionet që të duhen. Çmimin final e përcaktojmë hap pas hapi gjatë konsultës falas, pa asnjë detyrim.' },
    ...
    contact: {
      ...
      emailBtn: 'Na shkruaj me email',
      emailSubject: 'Kërkesë për konsultë — ORBIX',
  ...
  en: {
    ...
    nav: {
      links: [
        ...
        { label: 'Pricing', hash: '#paketat', testid: 'nav-link-pricing' },
    ...
    pricing: {
      ...
      accent: 'Plan',
      post: '',
      intro: 'Two clear plans — the final price is tailored to your business during your free consultation.',
      oneTime: '/one-time',
      monthlyLabel: '+',
      recommended: 'Recommended',
      waGreeting: 'Hello ORBIX! I\'m interested in the',
      plans: [
        {
          eyebrow: 'Core',
          name: 'Core Agent',
          ...
          featured: false,
          features: [
            '100% tailored AI agent for your business',
            '24/7 automatic replies within seconds',
            ...
            'Built-in knowledge base (services, prices, hours)',
            'Monthly performance reports + email support',
          ],
          addon: "+€200 — don't have a website yet? We'll build one: modern, responsive, up to 7 pages.",
          cta: 'Get started',
        },
        {
          eyebrow: 'Omni',
          ...
          featured: true,
          features: [
            'Everything in Core Agent',
            'Extra channels: Instagram (DMs+comments) & Facebook Messenger',
            'Unified conversation history across every channel',
            'Live private dashboard, in real time',
            'Automatic lead export (CRM/Sheets ready)',
            'Advanced performance analytics',
            'Reads & analyzes complex documents',
            'Priority 24/7 support',
          ],
          addon: '+€300 — premium website up to 12 pages, SSL + free hosting/domain for 1 year.',
          cta: 'Get Omni',
        },
      ],
    },
    ...
    faq: {
      ...
      post: '',
      items: [
        { q: 'How much does an AI agent cost for my business?', a: 'Our plans start at €300 + €99/month for Core Agent, up to €500 + €179/month for Omni Agent — depending on the channels and features you need. We work out the final price step by step during your free consultation, with zero obligation.' },
    ...
    contact: {
      ...
      emailBtn: 'Email Us',
      emailSubject: 'Consultation request — ORBIX',
